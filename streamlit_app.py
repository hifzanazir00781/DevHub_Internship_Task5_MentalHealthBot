...
# --- HYBRID THEME UI (Supports Dark & Light Mode) ---
st.markdown("""
    <style>
    /* Global Styles */
    .stApp {
    ...
    .top-dev-line {
        ...
        letter-spacing: 1px;
        margin-top: -60px;
        color: var(--text-color); /* Automatically switches based on theme */
    }

    /* Sidebar Profile - Solid Color for Visibility */
    .sidebar-profile {
        background: #2e7d32;
        padding: 20px;
        border-radius: 15px;
...
with st.sidebar:
    ...
    <div class="sidebar-profile">
        <h3 style="margin:0; color: white;">Hifza Nazir</h3>
        <p style="margin:0; font-size: 0.8rem; opacity: 0.9; color: white;">AI Engineering Intern</p>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown("### 📘 Task 5: Mental Health Bot")
    st.info("Fine-tuning DistilGPT2 on EmpatheticDialogues for emotional wellness support.")
...
st.markdown("<p style='text-align: center; font-size: 1.1rem;'>An Intent-Aware Emotional Support Agent</p>", unsafe_allow_html=True)
st.write("---")
